INSERT INTO tenant01.users (user_id, name, tenant, email, password) VALUES
('73a213fe-61cc-4935-be15-fcad1280d07e', 'nando', 'bar do nando', 'nando@store.com', 'password');

INSERT INTO tenant01.enterprises (enterprise_id, user_id, logo, document) VALUES 
('24338b5f-47e6-447b-9243-afe1982ba169', '73a213fe-61cc-4935-be15-fcad1280d07e', '', '00000000000');

INSERT INTO tenant01.enterprise_users(enterprise_user_id, user_id, enterprise_id, role) VALUES 
('dc33e84a-c8a4-4365-b30a-edb9cecf1bc4', '73a213fe-61cc-4935-be15-fcad1280d07e', '24338b5f-47e6-447b-9243-afe1982ba169', 'owner');

INSERT INTO tenant01.permissions(permission_id, type, description) VALUES 
('d3cb971a-4277-4a2d-a019-db360474a419', 'admin', 'Administrador');

INSERT INTO tenant01.user_permissions(user_permission_id, user_id, permission_id) VALUES
('1d020ae2-0cbe-4c0d-bd6f-f9934e828031', '73a213fe-61cc-4935-be15-fcad1280d07e', 'd3cb971a-4277-4a2d-a019-db360474a419');

INSERT INTO tenant01.clients (client_id, name, email, document) VALUES
...
INSERT INTO tenant01.brands (brand_id, name, description) VALUES
...
INSERT INTO tenant01.categories (category_id, name, description) VALUES
...
INSERT INTO tenant01.suppliers (supplier_id, name, email, phone) VALUES
...
INSERT INTO tenant01.products (product_id, name, image, brand_id, category_id, supplier_id, quantity, quantity_min, price_cost, selling_price, validate_date, status) VALUES
...
INSERT INTO tenant01.stock_movements (stock_movement_id, product_id, quantity_changed, reason) VALUES
...
INSERT INTO tenant01.shopping(shopping_id, supplier_id, product_id, price_cost, quantity) VALUES
...
INSERT INTO tenant01.cashier(cashier_id, opening_amount, status, opened_at, closed_at, user_opened_id, user_closed_id, total_sales, closing_amount) VALUES
...
('ee549196-b863-44cc-8857-8045463e93af', 100, 'open', '2025-04-05 07:30:05.923341', null, '73a213fe-61cc-4935-be15-fcad1280d07e', null, null, null);

INSERT INTO tenant01.cashier_moviments(cashier_moviment_id, cashier_id, user_id, type, amount, reason) VALUES 
...
INSERT INTO tenant01.sales(sale_id, user_id, client_id, cashier_id, parcial_price, discount, total, status, sale_date) VALUES 
...
INSERT INTO tenant01.sale_products(sale_product_id, sale_id, product_id, product_name, price_coust, price_sale, quantity, total_price) VALUES 
...
INSERT INTO tenant01.addresses(address_id, entity_id, street, number, city, state, country, postal_code, complement) VALUES
